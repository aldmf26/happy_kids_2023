...
@section('content')
                            ...
                            <tbody>
                                ...
                                @foreach ($invoice_periksa as $n)
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="teksLimit{{ $n->id_dokter }}">{{ Str::limit($n->nm_dokter, '14', '...') }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nominalBayar" name="rupiah" readonly
                                        class="form-control">
    ...
    <form action="{{ route('save_status') }}" method="post">
        @csrf
        <div class="modal fade text-left" id="pay" role="dialog" aria-labelledby="myModalLabel33"
            aria-hidden="true">
    ...
    {{-- form tambah --}}
    <div class="modal fade text-left" id="view_member" role="dialog" aria-labelledby="myModalLabel33"
        aria-hidden="true">
